...
parser = argparse.ArgumentParser("Darts-MNIST-train_search")
...
def main():
  ...
  model = Network(args.init_channels, MNIST_CLASSES, args.layers, criterion)
  ...
  for epoch in range(args.epochs):
    ...
    # training
    train_acc_top1, train_acc_top5, train_obj = train(train_queue, valid_queue, model, architect, criterion, optimizer, lr)
